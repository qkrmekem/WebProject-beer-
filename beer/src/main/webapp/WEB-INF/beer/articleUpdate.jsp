...
<head>
	...
	<script type="text/javascript">
  	...
  	/*$(document).ready(function () {
  		console.log("악!!!!");
  		var b_file= "${vo.b_file}";
  		console.log(b_file);
  		if(b_file != null){
  			$("#b_file").val(`C:\fakepath\`+b_file);
  			$("#upload-name-pik").val(`C:\fakepath\`+b_file);
  		}
					...
					<div>
						...
						<div class=".viewbox_pik" style="border: 1px solid #ccc; border-radius: 2%; padding: 20px 20px 100px 20px">
							<div class="ArticleContentBox_pik">
								<form action="${cpath}/articleUpdate.pik" method="post" enctype="multipart/form-data">
									...
									<div class="article_header_pik" style="position: relative; margin-bottom: 20px; padding: 0 20px; border-bottom: 1px solid #ccc;">
										<div class="ArticleTitle_pik" style="font-size: 13px;">										
											<input type="text" name="b_title" class="form-control" value="${vo.b_title}" style="font-size: 1.5em; width: 100%; padding: 0; margin-bottom: 20px;"/></td>
										</div>
									</div>
